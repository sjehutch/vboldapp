...
Private Sub btnValidate_Click()
    ...
    frmMain.txtOutput.text = frmMain.txtOutput.text & "Entering Validate" & vbCrLf
    ...
    frmMain.txtOutput.text = frmMain.txtOutput.text & "Site Code: " & Me.txtSiteCode.text & vbCrLf
    
    sSiteKey = Trim(CStr(txtSiteKey.text))
    frmMain.txtOutput.text = frmMain.txtOutput.text & "sSiteKey: " & sSiteKey & vbCrLf

    ' Save the site key. If it is invalid return an error message
    nErrorCode = objCrypKey.SaveSiteKey(sSiteKey)
    
    frmMain.txtOutput.text = frmMain.txtOutput.text & "SaveSiteKey ErrorCode: " & nErrorCode & vbCrLf
